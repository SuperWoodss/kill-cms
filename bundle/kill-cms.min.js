...
$(function () {
    ...
    var killHandler = function killHandler() {
        var $output = $('#output');
        ...
        var cms = {
            ...
            enpquot: '#enpquot#',
            Picture: {
                needcode: ['<img data-src="<Picture needcode=0>PictureUrlPh</Picture>" width="' + imgWidth + '" height="' + imgHeight + '" alt="<Title length="0">TitlePh</Title>">', '<Picture needcode=1 width=' + imgWidth + ' height=' + imgHeight + '>PictureUrlPh</Picture>']
            },
        ...
        orgHtml = orgHtml.replace(/UrlBegin/g, '<Url>').replace(/UrlEnd/g, '</Url>').replace(/</g, cms.lt).replace(/>/g, cms.gt).replace(/"/g, cms.enpquot);
