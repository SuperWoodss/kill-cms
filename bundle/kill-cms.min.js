...
$(function () {
    ...
    var killHandler = function killHandler($tempDOM, i) {
        ...
        var killAttrs = killConfigArray[i] ? killConfigArray[i] : ['未命名', '888888', '默认', 0];
        ...
        var repeat = killAttrs[3];
        var dayspan = repeat < 200 || repeat === undefined ? 0 : repeat;
        ...
        if ($tempDOM.is('ul')) {
            ...
            if (repeat > 1) {
                // 添加 Article
                orgHtml = '<Repeat Begin=0 End=' + repeat + '>\n                        <Article>\n                            ' + orgHtml + '\n                        </Article>\n                    </Repeat>';
            } else {
                // 添加 Article
