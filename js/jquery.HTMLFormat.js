 ...
 * @(demo)Last modified time: 2016-08-18-10:03:03
 */
$.HTMLFormat = function (data, opt) {
    var wrap = true;
    var defaultOpt = {
        indent_size: 4,
        indent_character: ' ',
    ...
    function style_html(html_source, indent_size, indent_character, max_char) {
        ...
        function Parser() {
            ...
            this.printer = function (js_source, indent_character, indent_size, max_char) {
                ...
                this.indent_size = indent_size || 0;
                this.indent_level = 0;
    ...
    // function style_html(html_source, indent_size, indent_character, max_char) {...}
    data = style_html(data, opt.indent_size, opt.indent_character, opt.max_char);
